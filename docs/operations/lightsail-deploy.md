...
- SSH into the Lightsail instance or use a GitHub Actions workflow later
- Run `deploy/deploy.sh`
- The script pulls the latest code, installs dependencies, refreshes the schema if needed, and restarts the service
